...
class SignalScanner:
    ...
    def scan_multi_timeframe(self, symbol: str, intervals: list = None,
        ...
        strength = 0.0
        confidence = 0
        # Normalise against the timeframes that actually produced a signal, and
        # penalise disagreement instead of ignoring the losing side.
        if voted_weight > 0 and long_weight != short_weight:
            ...
            agreement = voted_weight / sum(TF_WEIGHTS.get(t, 1.0) for t in intervals)
